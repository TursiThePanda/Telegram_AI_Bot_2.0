...
(
    ...
    CUSTOM_SCENERY_NAME,      # 15
    CUSTOM_SCENERY_PROMPT,    # 16

    # === Data Management Flow ===
    DELETE_MENU,              # 17
    DELETE_CUSTOM_PERSONA_SELECT, # 18
    DELETE_CUSTOM_SCENERY_SELECT, # 19 <<< NEW
    ...
    NSFW_GEN_GENDER,          # 22
    NSFW_GEN_ROLE,            # 23
    NSFW_GEN_FETISHES,        # 24
    NSFW_GEN_CONFIRM,         # 25

) = range(26) # (Updated count)